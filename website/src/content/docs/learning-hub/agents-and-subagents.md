...
Yes. As of v1.0.72, **multi-turn subagents are always enabled** — you can send follow-up messages to a subagent that is still running, without waiting for it to complete first. This makes it easier to steer long-running parallel tasks in real time.
